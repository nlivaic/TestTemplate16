    ...
    IAsyncLifetime
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        builder.ConfigureTestServices(services =>
        {
            ...
            services.Remove(services.SingleOrDefault(d => d.ServiceType == typeof(IDbContextOptionsConfiguration<TestTemplate16DbContext>)));
            ...
            var ctx = scopedServices.GetRequiredService<TestTemplate16DbContext>();
    ...
    public TestTemplate16DbContext CreateDbContext(ITestOutputHelper testOutput = null)
    {
    ...
    {
        private readonly DbContextOptions<TestTemplate16DbContext> _options;
        ...
        {
            _options = new DbContextOptionsBuilder<TestTemplate16DbContext>()
        ...
        public TestTemplate16DbContext BuildContext() =>
            new(_options);
    }
}

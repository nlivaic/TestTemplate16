...
using TestTemplate16.Api.Middlewares;
using TestTemplate16.Application;
using TestTemplate16.Core;
using TestTemplate16.Data;

namespace TestTemplate16.Api;
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        {
            var sqlConnectionStringBuilder = new SqlConnectionStringBuilder(_configuration["TestTemplate16DbConnection"] ?? string.Empty);
        ...
        services.AddSwaggerGen(setupAction =>
        {
            ...
            setupAction.SwaggerDoc(
                "TestTemplate16OpenAPISpecification",
                new OpenApiInfo
                {
                    Title = "TestTemplate16 API",
                    Version = "v1",
                    Description = "This API allows access to TestTemplate16.",
            ...
            setupAction.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TestTemplate16.Api.xml"));
        });
        ...
        services.AddCors(o => o.AddPolicy("TestTemplate16Client", builder =>
        {
        ...
        services.AddTestTemplate16ApplicationHandlers();
        ...
        services
            .AddHealthChecks()
            .AddDbContextCheck<TestTemplate16DbContext>();
    }
    ...
    public void Configure(IApplicationBuilder app)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/TestTemplate16OpenAPISpecification/swagger.json", "TestTemplate16 API");
